          ...
          <div class="col-xl-12 d-flex flex-row align-items-center justify-content-end">
            ...
            <div class="filter d-flex flex-row align-items-center justify-content-end">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#"><i class="bi bi-send-plus"></i> Resend Invoice</a></li>
                    <li><a class="dropdown-item" href="#"><i class="bi bi-receipt-cutoff"></i> Clone Invoice</a></li>
