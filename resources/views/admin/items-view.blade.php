...
<main id="main" class="main">
            ...
            <div class="card-body p-4">
              ...
              <form class='itemForm'>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="inputText" value="{{$item->name}}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Price</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="price" id="inputEmail" value='{{$item->price}}'>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">GST (%)</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="gst" id="inputEmail" value='{{$item->gst}}'>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" id="inputPassword" name="description" value="{{$item->description}}"></textarea>
                  </div>
                </div>
  ...
  <script>
    ...
    form.addEventListener("submit", async (e) => {
      ...
      axios.post('http://127.0.0.1:8000/admin/items/'+id+'/edit', data, {
        headers: { 
        ...
        // if(success){
          window.location.href = "http://127.0.0.1:8000/admin/items";
        // }
      });
    });
